...
var Fields = {
  'input-text': {
    'react-mantine': lazyPreload(function () {
      return import('./index-j3en2Ajt.js');
    })
  },
  'input-number': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DJcrcX0j.js');
    })
  },
  'textarea': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BYRMBKCs.js');
    })
  },
  'select': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DWu6J8rb.js');
    })
  },
  'checkbox': {
    'react-mantine': lazyPreload(function () {
      return import('./index-WGcuu6PP.js');
    })
  },
  'toggle': {
    'react-mantine': lazyPreload(function () {
      return import('./index-e8EmId0W.js');
    })
  },
  'array': {
    'react-mantine': lazyPreload(function () {
      return import('./index-ClwV8Hut.js');
    })
  },
  'checkbox-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-pqFpCMC-.js');
    })
  },
  'radio-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DY00zYmq.js');
    })
  },
  'two-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-C5iMkDOM.js');
    })
  },
  'three-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-C_R8Ho2L.js');
    })
  },
  'columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BYvt2Oe7.js');
    })
  },
  'group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CIxMqiPC.js');
    })
  },
  'date': {
    'react-mantine': lazyPreload(function () {
      return import('./index-wkTZh-uX.js');
    })
  },
  'datetime': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Cy1IExli.js');
    })
  },
  'rate': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BzloLGHe.js');
    })
  },
  'placeholder': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DCsO1BGt.js');
    })
  },
  'placeholder-image': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CrNRfrzW.js');
    })
  },
  'divider': {
    'react-mantine': lazyPreload(function () {
  ...
  'slider': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DaUDIWcm.js');
    })
  },
  'input-tag': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DGErfWBD.js');
    })
  },
  'tabs': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DkJQNR3a.js');
    })
  },
  'button': {
    'react-mantine': lazyPreload(function () {
      return import('./index-q-tKYM_n.js');
    })
  },
  'upload': {
    'react-mantine': lazyPreload(function () {
      return import('./index-D-0S3740.js');
    })
  },
  'multiselect': {
    'react-mantine': lazyPreload(function () {
      return import('./index-B49btq95.js');
    })
  },
  'steps': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BBrIfii_.js');
    })
  },
  'time': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CBXjhIDC.js');
    })
  },
  'hidden': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CLbGUquT.js');
    })
  }
};
var Forms = {
  'react-mantine': lazyPreload(function () {
    return import('./index-CRm4HKMq.js');
  })
};
